...
impl DHCP6ConfigProxy<'_> {
    pub async fn new_from_path(device_path: zbus::zvariant::OwnedObjectPath, connection: &Connection) -> Result<DHCP6ConfigProxy<'_>> {
...
#[proxy(
    default_path = "/org/freedesktop/NetworkManager/DHCP6Config",
