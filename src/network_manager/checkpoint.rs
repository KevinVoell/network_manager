...
impl CheckpointProxy<'_> {
    pub async fn new_from_path(device_path: zbus::zvariant::OwnedObjectPath, connection: &Connection) -> Result<CheckpointProxy<'_>> {
...
#[proxy(
    default_path = "/org/freedesktop/NetworkManager/Checkpoint",
