...
impl StatisticsProxy<'_> {
    pub async fn new_from_path(device_path: zbus::zvariant::OwnedObjectPath, connection: &Connection) -> Result<StatisticsProxy<'_>> {
        StatisticsProxy::builder(&connection)
        .path(device_path)
...
#[proxy(
    default_path = "/org/freedesktop/NetworkManager/Device/Statistics",
