...
impl LowpanProxy<'_> {
    pub async fn new_from_path(device_path: zbus::zvariant::OwnedObjectPath, connection: &Connection) -> Result<LowpanProxy<'_>> {
...
#[proxy(
    default_path = "/org/freedesktop/NetworkManager/Device/Lowpan",
