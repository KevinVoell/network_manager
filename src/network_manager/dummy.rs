...
impl DummyProxy<'_> {
    pub async fn new_from_path(device_path: zbus::zvariant::OwnedObjectPath, connection: &Connection) -> Result<DummyProxy<'_>> {
...
#[proxy(
    default_path = "/org/freedesktop/NetworkManager/Device/Dummy",
